    ...
    return (
        <nav className=" px-4 md:px-12 py-4 md:py-6 bg-white text-black ">
           <div className=" flex justify-between items-center">
            ...
            >Zwatches</Link>
            <div className=" relative max-w-sm md:w-md">
                <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                    <Search className="w-4 h-4"/>
                </div>

                <input type="text" onChange={handleChange} 
                className="h-9 relative pl-10 border-[1px] border-black/[0.7] text-sm rounded-md w-full py-2 px-3 focus:outline-none bg-transparent"
                placeholder="Search" />
            </div>
