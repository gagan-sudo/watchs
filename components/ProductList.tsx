...
const ProductList = () => {
  ...
  return (
    ...
    >
       {products.length !==0 ?<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
       {
      ...
      </div>: <div className="  text-center text-xl  ">Do not have any product</div>}
    </div>
  );
};
